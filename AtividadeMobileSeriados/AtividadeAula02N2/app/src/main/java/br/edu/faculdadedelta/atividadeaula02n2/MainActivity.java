...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNota = (RatingBar)findViewById(R.id.ratingBar);
        ...
        etNota = findViewById(R.id.ratingBar);
    ...
    private void popularFormulario(Seriados seriadosSelecionado){
       ...
       // etNota.setText(Double.valueOf(etNota.getRating()));
        etNota.setNumStars(seriados.getNota());
    ...
    private void popularModelo(){
        ...
        seriados.setNota(etNota.getProgress());
    ...
    public void salvar(View view) throws ParseException {
       ...
       // String nota = etNota.getText().toString();
        Double ratingBar = Double.valueOf(etNota.getRating());
        ...
        if (genero.isEmpty() && status.isEmpty() && nome.isEmpty() && comentario.isEmpty() && ratingBar == 0 && dataTexto.isEmpty()){
